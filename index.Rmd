...
O pacote _magrittr_ fornece um conjunto de operadores que tornam seu código mais fácil de ler.
...
Recomendações do próprio Hadley Wickham no livro: [The tidyverse style guide](https://style.tidyverse.org/pipes.html)
...
magrittr permite a omissão dos `()` em funções que não têm argumentos. Evite 
isso.
